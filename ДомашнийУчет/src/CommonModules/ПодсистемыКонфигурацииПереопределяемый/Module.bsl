...
Процедура ПриДобавленииПодсистем(МодулиПодсистем) Экспорт
	...
	// --> akifjev начало блока 01.05.2024 11:20:34
	ОбновлениеИнформационнойБазыДомашнийУчет.ПриДобавленииПодсистем(МодулиПодсистем);
	// <-- akifjev конец блока 01.05.2024 11:20:34
