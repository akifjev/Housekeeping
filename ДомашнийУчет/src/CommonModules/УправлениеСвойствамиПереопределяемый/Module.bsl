...
Процедура ПриПолученииПредопределенныхНаборовСвойств(Наборы) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ПриПолученииПредопределенныхНаборовСвойств(Наборы);
	// <-- akifjev конец блока
...
Процедура ПриПолученииНаименованийНаборовСвойств(Наименования, КодЯзыка) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ПриПолученииНаименованийНаборовСвойств(Наименования, КодЯзыка);
	// <-- akifjev конец блока
...
Процедура ЗаполнитьНаборыСвойствОбъекта(Знач Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ЗаполнитьНаборыСвойствОбъекта(Объект, ТипСсылки, НаборыСвойств, СтандартнаяОбработка, КлючНазначения);
	// <-- akifjev конец блока
...
Процедура ПриНастройкеНачальногоЗаполненияЭлементов(Настройки) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ПриНастройкеНачальногоЗаполненияЭлементов(Настройки);
	// <-- akifjev конец блока
...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти);
	// <-- akifjev конец блока
...
Процедура ПриНачальномЗаполненииЭлемента(Объект, Данные, ДополнительныеПараметры) Экспорт
	...
	// --> akifjev начало блока
	УправлениеСвойствамиДомашнийУчет.ПриНачальномЗаполненииЭлемента(Объект, Данные, ДополнительныеПараметры);
	// <-- akifjev конец блока
